...
ToolButton::ToolButton(std::string img, std::string imgIn, Engine::Sprite Base, Engine::Sprite Tool, float x, float y, int money) : ImageButton(img, imgIn, x, y), money(money), Base(Base), Tool(Tool){
}
